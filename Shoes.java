...
public class Shoes extends Product
{
	...
	public Shoes(String name,String id, double price, int size6BlackStock, int size6BrownStock, int size7BlackStock, int size7BrownStock, int size8BlackStock,
				 int size8BrownStock, int size9BlackStock, int size9BrownStock, int size10BlackStock, int size10BrownStock, int stats)
	...
	public void reduceStockCount(String productOptions)
	{
		switch (productOptions)
		{
			...
			case "9 Black": size9BlackStock--; break;
			case "9 Brown": size9BrownStock--; break;
